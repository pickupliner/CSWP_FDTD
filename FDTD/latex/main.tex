...
yields \(o_x\).
This boundary condition does not prevent waves from entering the PEC,
which was mitigated by setting \(p\) equal to zero inside the PEC.
...
...
The tilted grid makes the implementation of the tilted PEC easier and more accurate. 
