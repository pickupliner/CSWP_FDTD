...
kappa_pw = kappa_horizontal_p + kappa_up_p * np.cos(theta)
kappa_pv = 0                  + kappa_up_p * np.sin(theta)
kappa_ow = kappa_horizontal_ow[1:-1,:] + kappa_up_p          * np.cos(theta)
kappa_ov = 0                           + kappa_up_ov[:,1:-1] * np.sin(theta)
